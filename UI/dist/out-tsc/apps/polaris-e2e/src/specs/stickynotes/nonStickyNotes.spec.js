...
describe('Verify if the user is able to add a new Non sticky note', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
    const pg = require('pg');
    ...
    it('Verify user is able to add a Non sticky note', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
describe('Validate if the user is able to edit the  Non sticky note', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
describe('Validate if user is able to delete the  Non sticky Note', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=nonStickyNotes.spec.js.map